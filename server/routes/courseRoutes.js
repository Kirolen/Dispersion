...
router.get('/course-name/:courseId', authMiddleware, courseController.getCourseById);
router.get('/course-info-people/:courseId', authMiddleware, courseController.getCoursePeople);
