...
router.get('/get-all-assignments-for-one-course-by-teacher/:userId/:courseId', roleMiddleware("Teacher"), materialController.getAllAssignmentsForOneCourseByTeacher)
